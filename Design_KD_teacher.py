...
class ResNet18(nn.Module):
    def __init__(self, classes_num=7):
...
input_features = model_resnet101.fc.in_features
model_resnet101.fc = nn.Linear(input_features, 10)
# print(model_resnet101)
# class DomainConv(nn.Module):
#     def __init__(self):
#         super(DomainConv, self).__init__()
#         self.conv1 = nn.Conv2d(1, 7, kernel_size=14)
