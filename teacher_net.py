...
class Vgg16_net(nn.Module):
    def __init__(self):
        ...
        self.layer1=nn.Sequential(
            nn.Conv2d(in_channels=3,out_channels=64,kernel_size=3,padding=1), #(32-3+2)/1+1=32   32*32*64
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=64,out_channels=64,kernel_size=3,padding=1), #(32-3+2)/1+1=32    32*32*64
            nn.ReLU(inplace=True),
        ...
        self.layer2=nn.Sequential(
            nn.Conv2d(in_channels=64,out_channels=128,kernel_size=3,padding=1),  #(16-3+2)/1+1=16  16*16*128
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=128,out_channels=128,kernel_size=3,padding=1), #(16-3+2)/1+1=16   16*16*128
            nn.ReLU(inplace=True),
            nn.MaxPool2d(2,2)    #(16-2)/2+1=8     8*8*128
        )

        self.layer3=nn.Sequential(
            nn.Conv2d(in_channels=128,out_channels=256,kernel_size=3,padding=1),  #(8-3+2)/1+1=8   8*8*256
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=256,out_channels=256,kernel_size=3,padding=1),  #(8-3+2)/1+1=8   8*8*256
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=256,out_channels=256,kernel_size=3,padding=1),  #(8-3+2)/1+1=8   8*8*256
            nn.ReLU(inplace=True),
        ...
        self.layer4=nn.Sequential(
            nn.Conv2d(in_channels=256,out_channels=512,kernel_size=3,padding=1),  #(4-3+2)/1+1=4    4*4*512
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=512,out_channels=512,kernel_size=3,padding=1),   #(4-3+2)/1+1=4    4*4*512
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=512,out_channels=512,kernel_size=3,padding=1),   #(4-3+2)/1+1=4    4*4*512
            nn.ReLU(inplace=True),
